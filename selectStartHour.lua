...
local function onOptionSelect(x)
   ...
   io.close( file )
   composer.gotoScene( "selectStartMinute", {effect="fade", time=200}) 
...
function scene:create( event )
	...
	titleText = display.newText( "Select start hour for task", contentWidth * .5, contentHeight*.1, native.systemFont ,contentHeight * .05)	
